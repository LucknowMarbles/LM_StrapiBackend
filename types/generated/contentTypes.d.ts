...
export interface ApiBatchBatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    BatchNo: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEnquiryEnquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DateOfEnquiry: Schema.Attribute.DateTime;
...
export interface ApiLocationHistoryLocationHistory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DateMovedTo: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::location-history.location-history'
    > &
      Schema.Attribute.Private;
...
export interface ApiPiecePiece extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CurrentWarehouse: Schema.Attribute.Relation<
      'oneToOne',
      'api::warehouse.warehouse'
    >;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::piece.piece'> &
      Schema.Attribute.Private;
    location_histories: Schema.Attribute.Relation<
      'oneToMany',
      'api::location-history.location-history'
    >;
    PieceNo: Schema.Attribute.String;
    products_enquiry: Schema.Attribute.Relation<
      'manyToOne',
      'api::products-enquiry.products-enquiry'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductUseProductUse extends Struct.CollectionTypeSchema {
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Image: Schema.Attribute.Media<
      ...
      true
    >;
    isecommerce: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
...
export interface ApiProductsEnquiryProductsEnquiry
  extends Struct.CollectionTypeSchema {
...
export interface ApiSizeSize extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HeightOrThickness: Schema.Attribute.Decimal;
...
export interface ApiWebsightUserWebsightUser
  extends Struct.CollectionTypeSchema {
